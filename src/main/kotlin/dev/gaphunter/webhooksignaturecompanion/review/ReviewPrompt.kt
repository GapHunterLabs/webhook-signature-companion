package dev.gaphunter.webhooksignaturecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.webhooksignaturecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.webhooksignaturecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Webhook Signature Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33789-webhook-signature-companion/reviews"
